            ...
            <div id="anamnese-header">
                <div class="report-row report-text-left margin-top-25">
                    ...
                    <div class="col grid-3">
                        <p><span>Peso: </span><?= $student['weight'] ?></p>
                    </div>
                    <div class="col grid-3">
                        <p><span>Idade: </span><?= $student['age'] ?></p>
                    </div>
                </div>

                <div class="report-row report-text-left">
                    <div class="col grid-6">
                        <p><span>Nascimento: </span><?= $student['birthday'] ?></p>
                    </div>
                    <div class="col grid-3">
                        <p><span>Hb1: </span><?= $student['rate1'] ?></p>
                    </div>
                    <div class="col grid-3">
                        <p><span>Altura: </span><?= $student['height'] ?></p>
                    </div>
                </div>

                <div class="report-row report-text-left">
                    <div class="col grid-6">
                        <p><span>Sexo: </span><?= $student['sex'] ?></p>
                    </div>
                    <div class="col grid-3">
                        <p><span>Imc: </span><?= $student['imc'] ?></p>
                    </div>
                    <div class="col grid-3">
                    </div>
                </div>
